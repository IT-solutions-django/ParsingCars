    ...
    async with session_factory() as db_session:
        async with db_session.begin():
            ...
            for column in TimeDealCar.__table__.columns:
                ...
                if field_name not in ("car_mark", "car_model"):
                    continue
                values = [getattr(car, field_name) for car in cars if getattr(car, field_name)]
            ...
            # value_origin = unique_values_original['car_model']
            # value_new = updated_unique_values['car_model']
            #
